...
/**
 * Creates an instance of Squiggle and adjusts the attributes
 * as the mouse moves and puts the shape into the model stack.
 */
public class SquiggleStrategy implements ShapeManipulatorStrategy, MouseListener, MouseMotionListener{
	...
	public void mousePressed(MouseEvent e) {
		 ...
		 */
		this.l = null;
		this.l = new Line(new Point(e.getX(), e.getY()));	
	...
	public void mouseDragged(MouseEvent e) {
		...
		try{
			...
			paintPanel.tempShape.drawSquiggle();
			paintPanel.repaint();
